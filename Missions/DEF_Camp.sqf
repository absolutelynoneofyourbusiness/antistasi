...
_airportsAAF = aeropuertos - mrkFIA;
{
	...
	if ((_airport in deadZones) AND {(_targetPosition distance _posAirport > 1500)}) then {_airports pushBack _airport};
...
[_airport, _targetPosition, "transport", _QRFsize, DURATION*60, 150, "campQRF"] remoteExec ["enemyQRF", HCattack];
